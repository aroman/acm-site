class Member < ActiveRecord::Base
  ...
  attr_accessible :username, :email, :password, :password_confirmation, :first_name, :last_name, :andrew_id, :major, :officer_position, :committe, :phone, :shirt_size, :year, :role
